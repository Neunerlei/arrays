...
class ArrayPathsTest extends TestCase {
	...
	public function testFilter() {
		...
		$r = Arrays::filterPath($this->getTree(), "rumpel.[pumpel.foo,grumpel]", function ($v) {
			if ($v !== 555 && $v !== "pumpFoo") $this->fail("Filter value was not as expected!");
			return TRUE;
		});
		$e = $this->getTree();
	...
	public function testGetListExamples() {
		...
		$this->assertEquals(
			...
			], Arrays::getList($this->getList(), ["array.id", "array.bar", "baz", "array.baz as baz2"], "id", ["default" => TRUE]));
